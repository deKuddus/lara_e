...
<head>
	...
	<link href="{{asset('serverSide/css/font-awesome-ie7.min.css')}}" rel="stylesheet">
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li>
							<a class="dropmenu" href="#"><i class="icon-envelope"></i><span class="hidden-tablet"> Categories</span></a>
							<ul>
								<li><a class="submenu" href="{{ route('category.create') }}"><i class="icon-file-alt"></i><span class="hidden-tablet"> Add Category</span></a></li>
								<li><a class="submenu" href="{{route('category.index')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> Category List</span></a></li>
							</ul>	
						</li>

						<li>
							<a class="dropmenu" href="#"><i class="icon-envelope"></i><span class="hidden-tablet"> Brands</span></a>
							<ul>
								<li><a class="submenu" href="{{ route('manufacturer.create') }}"><i class="icon-file-alt"></i><span class="hidden-tablet"> Add Brands</span></a></li>
								<li><a class="submenu" href="{{ route('manufacturer.index') }}"><i class="icon-file-alt"></i><span class="hidden-tablet"> Brands List</span></a></li>
							</ul>	
						</li>
						...
						<li>
							<a class="dropmenu" href="#"><i class="icon-envelope"></i><span class="hidden-tablet"> Products</span></a>
							<ul>
								<li><a class="submenu" href="{{ route('product.create') }}"><i class="icon-file-alt"></i><span class="hidden-tablet"> Add Product</span></a></li>
								<li><a class="submenu" href="{{ route('product.index') }}"><i class="icon-file-alt"></i><span class="hidden-tablet"> Products List</span></a></li>
							</ul>	
						</li>
...
<div id="content" class="span10">
	...
	<!-- start: JavaScript-->
		...
		<script src="{{asset('serverSide/js/jquery.ui.touch-punch.js')}}"></script>	
		...
		<script src="{{asset('serverSide/js/fullcalendar.min.js')}}"></script>	
		<script src="{{asset('serverSide/js/jquery.dataTables.min.js')}}"></script>
		<script src="{{asset('serverSide/js/excanvas.js')}}"></script>
		<script src="{{asset('serverSide/js/jquery.flot.js')}}"></script>
		<script src="{{asset('serverSide/js/jquery.flot.pie.js')}}"></script>
		<script src="{{asset('serverSide/js/jquery.flot.stack.js')}}"></script>
		<script src="{{asset('serverSide/js/jquery.flot.resize.min.js')}}"></script>	
		<script src="{{asset('serverSide/js/jquery.chosen.min.js')}}"></script>	
		<script src="{{asset('serverSide/js/jquery.uniform.min.js')}}"></script>		
		<script src="{{asset('serverSide/js/jquery.cleditor.min.js')}}"></script>	
		<script src="{{asset('serverSide/js/jquery.noty.js')}}"></script>	
		<script src="{{asset('serverSide/js/jquery.elfinder.min.js')}}"></script>	
		<script src="{{asset('serverSide/js/jquery.raty.min.js')}}"></script>	
		<script src="{{asset('serverSide/js/jquery.iphone.toggle.js')}}"></script>	
		<script src="{{asset('serverSide/js/jquery.uploadify-3.1.min.js')}}"></script>	
		<script src="{{asset('serverSide/js/jquery.gritter.min.js')}}"></script>	
		<script src="{{asset('serverSide/js/jquery.imagesloaded.js')}}"></script>
		<script src="{{asset('serverSide/js/jquery.masonry.min.js')}}"></script>	
		<script src="{{asset('serverSide/js/jquery.knob.modified.js')}}"></script>	
		<script src="{{asset('serverSide/js/jquery.sparkline.min.js')}}"></script>	
		<script src="{{asset('serverSide/js/counter.js')}}"></script>	
		<script src="{{asset('serverSide/js/retina.js')}}"></script>
		<script src="{{asset('serverSide/js/custom.js')}}"></script><!-- end: JavaScript-->
