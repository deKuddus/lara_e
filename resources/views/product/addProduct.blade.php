						...
						<form class="form-horizontal" method="post" action="{{  route('product.store') }}" enctype="multipart/form-data">
						  ...
						  <fieldset>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="input-xlarge" name="productName" id="productName" placeholder="Write product Name here">
							  </div>
							</div>
							...
							<div class="control-group hidden-phone">
							  ...
							  <div class="controls">
								<textarea class="cleditor" id="product_sd" name="product_sd" rows="3"></textarea>
							  </div>
							</div>
							...
							<div class="control-group hidden-phone">
							  ...
							  <div class="controls">
								<textarea class="cleditor" id="product_ld" name="product_ld" rows="3"></textarea>
							  </div>
							</div>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="input-xlarge" name="productPrice" id="productPrice">
							  </div>
							</div>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="input-xlarge" name="productColor" id="productColor" placeholder="Write product color here">
							  </div>
							</div>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="input-xlarge" name="productSize" id="productSize" placeholder="Write product Size here">
							  </div>
							</div>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="checkbox" class="input-xlarge" name="product_status" id="product_status" value="1">status
							  </div>
							</div>
